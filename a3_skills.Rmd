...
* **Load a package from GitHub**: If you want to edit the frequency on one or more transit routes, you'll find the GTFSedits package useful. This is a package I wrote specifically for this class, and it's still very much in beta. You'll need to install it from GitHub (this is common for beta versions of new or updated packages).
