...
* **Create a tree map:** Tree maps are nice way to visualize proportions while avoiding some of the pitfalls of pie charts. 
...
From the table above, I can see that 20 percent of households have incomes below \$25,000 per year, 36 percent have incomes below \$50,000 per year, 54 percent have incomes below \$75,000, and 82 percent have incomes below \$150,000 per year. These are thresholds I could use to define broader income categories (which approximately correspond to quintiles) for my tract-level data. 
